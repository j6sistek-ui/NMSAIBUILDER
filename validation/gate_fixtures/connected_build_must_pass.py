...
# Connectivity self-test fixture: all placed parts touch -> must PASS the no-float gate.
...
# Two S_FLOOR panels (extent_x ~ 5.245) placed 5.0 apart -> edges overlap -> connected.
