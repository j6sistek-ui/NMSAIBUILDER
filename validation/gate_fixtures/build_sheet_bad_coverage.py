...
TAG = "FIXTURE_BSHEET_"
PROJECT_BUILD_SHEET = "build_sheet_good.json"
...
part2 = BUILDER.add_part("S_FLOOR")
obj2 = getattr(part2, "object", part2)
obj2.name = TAG + "002_S_FLOOR"
obj2["ObjectID"] = "S_FLOOR"
obj2.scale = (1.0, 1.0, 1.0)
