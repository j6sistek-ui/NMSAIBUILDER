# 00 — Memory Recall Index

Status: active lean recall index. Historical archive files were removed from the main source package after useful lessons were consolidated.
...
- `data/FEATURE_RECIPE_ROUTE_INDEX.json`
...
- `rules/PART_ORIENTATION_OVERRIDES.md`
- `rules/WALL_SHELL_ENCLOSURE_RECIPE.md`
- `rules/DISCONNECTED_ASSEMBLY_HARDSTOP_RULE.md`

## Validation

- `validation/run_gate.py`
- `validation/feature_recipe_lookup_check.py`
- `validation/ai_review_bundle_check.py`
- `validation/request_router_check.py`
- `validation/protocol_banner_check.py`

## Source-doc governance
...
If a removed historical file is needed for audit, consult the external removed-file ledger and the superseded 2.19.00 / 2.18.01 packages.
