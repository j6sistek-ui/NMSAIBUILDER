...
- Major deliverables require a Project Transfer Summary so the project can survive chat-limit/context-loss events. If the user says `checkpoint`, generate `PROJECT_STATE_CURRENT.md` and `OPEN_ISSUES_CURRENT.md`. See `rules/PROJECT_TRANSFER_SUMMARY_RULE.md`.
